## AingDesk文档规范
AingDesk是一款简单好用的AI助手，支持知识库、模型API、分享、联网搜索、智能体、MCP，它还在飞快成长中。

## 文档规范

本文档旨在规范AingDesk所有对外文档（包括但不限于产品文档、API文档、白皮书文档等）的基本格式及风格。AingDesk文档书写语法为Markdown，关于Markdown的更多信息，可参考https://github.github.com/gfm/
...
AingDesk在线文档均在Github统一编辑发布，采用Markdown编写方式，文档中的的字体、颜色请保持默认风格，不要使用特殊字体、颜色。
AingDesk离线文档统一为PDF格式，请使用Markdown编辑器编写，有形如以上的规范。
...
5. 尽量避免中英文混杂。
6. 请一定注意“的”、“地”、“得”的用法。
7. 第一人称：推荐使用“AingDesk”、“我们”，不推荐使用“小编”、“笔者”。
...
#### 中文、英文、数字混排时空格的使用
1. 英文与非标点的中文之间需要有一个空格。如“使用宝塔一键迁移 API 版本迁移网站”而不是“使用宝塔一键迁移API版本迁移网站”。
...
<tr><td>App / 应用</td><td>APP、软件、程序</td></tr><tr><td>Android</td><td>android、安卓</td></tr><tr><td>iOS</td><td>ios、IOS</td></tr><tr><td>iPhone</td><td>IPHONE、iphone</td></tr>
